...
const getCircleStyle = (
    ...
    return {
        ...
        transform: `rotate(${rotateDeg + offsetDeg + (positionDeg as any)}deg)`,
...
const Circle: React.FC<ProgressProps> = ({
    ...
    const getStepStokeList = () => {
        ...
        const current = Math.round((stepCount as any) * ((percentList[0] as any) / 100));
        const stepPtg = 100 / (stepCount as any);
                ...
                <defs>
                    <linearGradient id={gradientId} x1="100%" y1="0%" x2="0%" y2="0%">
                        {Object.keys(gradient)
                            ...
                            .map((key, index) => (
                                <stop key={index} offset={key} stopColor={((gradient as any)[key] as any)} />
                            ))}
                    </linearGradient>
                </defs>
            )}
